...
const PasskeyModal = () => {
    ...
    const encrypedKey = typeof window !== "undefined" ? window.localStorage.getItem("accessKey") : null
        ...
        <AlertDialog open={open} onOpenChange={setOpen}>
            <AlertDialogContent className="shad-alert-dialog">
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        Too access the admin page, please enter the passkey.
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <div>
                ...
                <AlertDialogFooter>
                    <AlertDialogAction className="shad-primary-btn w-full" onClick={(e) => validatePasskey(e)}>Enter Admin Passskey</AlertDialogAction>
                </AlertDialogFooter>
            </AlertDialogContent>
        </AlertDialog>
